...
export function ExportsTable({
  ...
  return (
    <div className="space-y-4">
      ...
      >
        {/* Header */}
        <div className="hidden md:grid md:grid-cols-[0.7fr_1fr_0.8fr_0.6fr_0.6fr] gap-4 px-5 py-3 bg-muted/30">
          ...
          <div className="divide-y divide-border/40">
            {exports.map((exp) => (
              <div
                ...
                className="grid cursor-pointer gap-2 px-5 py-4 transition-colors hover:bg-secondary/30 md:grid-cols-[0.7fr_1fr_0.8fr_0.6fr_0.6fr] md:items-center md:gap-4"
              >
