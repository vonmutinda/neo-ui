...
interface BusinessCurrencyCardsProps {
  balances: BusinessCurrencyBalance[];
}

export function BusinessCurrencyCards({
  balances,
}: BusinessCurrencyCardsProps) {
